...
function EditItem() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(error);
            setLoading(false)
            toast.error("Error in updating food item")
        }
    }
        ...
        <div className='flex justify-center flex-col items-center p-6 bg-linear-to-br from-orange-50 relative to-white min-h-screen'>
            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    hover:bg-orange-600 hover:shadow-lg duration-200 cursor-pointer hover:scale-102 transition-transform'
                    disabled={loading}>
                        {loading? <ClipLoader size={20} color='white'/>:"Update Food"}
                    </button>
                </form>
            </div>
        </div>
