...
function Shop() {
    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            <button className='absolute top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3
            py-2 rounded-full shadow-transition cursor-pointer' onClick={()=>navigate('/')}>
                <FaArrowLeft />
                <span>Back</span>
            </button>
            ...
            text-center px-4'>
                        ...
                        <div className='flex items-center gap-[10px]'>
                            <p className='text-lg gap-2 flex font-medium text-gray-300 mt-4'><FaLocationDot size={22} color='red' />{" "} {shop.address}</p>
                        </div>
                    </div>
                </div>
            }
